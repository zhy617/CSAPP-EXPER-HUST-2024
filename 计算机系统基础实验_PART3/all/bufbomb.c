...
void bang(int val)
{
    if (global_value == cookie) {
        ...
        // printf("Bang!: You set global_value to 0x\n");
        validate(2);
    } else
...
/*
gcc -g -fno-stack-protector -no-pie bufbomb.c buf.c support.c -o bufbomb -D U5

./bufbomb U202210755 string1.txt 0

gcc -g -D U5 -fno-stack-protector -no-pie -fcf-protection=none -z execstack bufbomb.c buf.c support.c -o bufbomb
*/
